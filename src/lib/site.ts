...
export const SITE = {
  ...
  research:
    'My research goal is to <strong>expand people’s capacity to create and learn</strong> by building interactive systems with <strong>generative AI</strong> and <strong>extended reality</strong> that adapt content to their actions, context, and intentions. My work spans AI-assisted filmmaking, technology-enhanced learning, and embodied fitness training. This work has been recognized and supported by the <a href="https://www.colorado.edu/graduateschool/2025/10/24/cu-boulder-graduate-student-named-google-phd-fellow" target="_blank" rel="noopener">Google Ph.D. Fellowship</a>.',
